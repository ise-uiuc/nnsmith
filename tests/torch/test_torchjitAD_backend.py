...
def test_narrow_spec_cache_make_and_reload():
    factory = BackendFactory.init("torchjitAD", ad="forward", target="cpu", optmax=True)
...
def test_synthesized_tf_model_forward(tmp_path):
    ...
    for target in targets:
        ...
        oracle = model.make_oracle(ad="forward")
...
def test_synthesized_tf_model_backward():
    ...
    for target in targets:
        ...
        oracle = model.make_oracle(ad="backward")
