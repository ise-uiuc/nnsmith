...
TF_REALIZABLE_OPS = [Add, Dense, LocalRespNorm]
...
# #         [[0, 0], [0, 0], [op.padding, op.padding], [op.padding, op.padding]]
# #     )

# #     class _Conv2D(tf.Module):
# #         def __init__(self):
# #             super().__init__()
...
# #                 strides=(op.stride, op.stride),
# #                 data_format="channels_first",  # NCHW NOTE: can only run on GPU
